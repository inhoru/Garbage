...
SELECT EMP_NAME AS 이름,SALARY*12 AS 연봉,(SALARY+(SALARY*BONUS))*12 AS 총수령액,(SALARY+(SALARY*BONUS))*12-((SALARY*12)*0.03) AS 실수령액
FROM EMPLOYEE;
...
SELECT EMP_NAME AS 이름, SALARY AS 월급,(SALARY+(SALARY*BONUS))*12-((SALARY*12)*0.03) AS 실수령액 , HIRE_DATE
FROM EMPLOYEE
WHERE ((SALARY+(SALARY*BONUS))*12)-(SALARY*0.03)>=50000000;
...
SELECT COUNT(*) AS 전체직원수,COUNT(CASE WHEN EXTRACT(YEAR FROM HIRE_DATE) =2001 THEN 1 END) AS "2001년",COUNT(CASE WHEN EXTRACT(YEAR FROM HIRE_DATE) =2002 THEN 1 END) AS "2002년",COUNT(CASE WHEN EXTRACT(YEAR FROM HIRE_DATE) =2003 THEN 1 END) AS "2003년",COUNT(CASE WHEN EXTRACT(YEAR FROM HIRE_DATE) =2004 THEN 1 END) AS "2004년"
FROM EMPLOYEE;
